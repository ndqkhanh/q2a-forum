        ...
        <View style={styles.questionFooterContainer}>
            ...
            <TouchableOpacity flexDirection={'row'}>    
              <View flexDirection={'row'} alignItems={'center'}>
                <Icon name="checkmark-outline" style={styles.verifyIcon} color={Colors.green10}/>
            ...
            <TouchableOpacity> 
              <View flexDirection={'row'} alignItems={'center'}>
                <Icon name="close-outline" style={styles.verifyIcon} color={Colors.red10} />
                <Text style={styles.disapprove} red>Disapprove</Text>
              </View>
              </TouchableOpacity> 
            </Card>
        </View>
